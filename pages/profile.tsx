...
const Account = () => {
  ...
  return (
    <div className="min-h-screen flex py-10 items-center justify-center">
      <div className="border-gray-200 border-2 p-8 shadow-2xl bg-white w-1/2 nt-10 rounded-lg">
          ...
          <div className='flex items-center justify-center'>
            <button
                ...
                className={
                  ...
                  : 'block text-white rounded-lg border-2 bg-red-400 w-1/2 p-4 font-semibold hover:bg-red-300 hover:text-gray-100 '
                }
              >
